    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" onclick="add();closeNoty()">&times;</button>
            </div>
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <input id="datetimepicker" type="text"  name="dateTime" placeholder="<spring:message code="meal.dateTime"/>">
                    </div>
